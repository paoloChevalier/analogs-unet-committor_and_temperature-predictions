...
callbacks = [
    ...
    keras.callbacks.ModelCheckpoint("models/psl_zg_pr10_to_tas_era5_lag5.keras", save_best_only=True),
]
...
ds.to_netcdf("models/psl_zg_pr10_to_tas_era5_lag5.nc")
model.save("models/psl_zg_pr10_to_tas_era5_lag5.keras")
np.save('models/psl_zg_pr10_to_tas_era5_lag5.npy',history.history)
