...
if __name__ == "__main__":
    ...
    dataset_val = CustomDataset(
        psl_file_val, zg_file_val, pr10_file_val, tas_file_val, batch_size=64, lag=3,
    ...
    callbacks = [
        ...
        keras.callbacks.ModelCheckpoint("models/psl_zg_pr10_tas_to_tas_era5_lag3_COMMITTOR.keras", save_best_only=True),
    ]
    ...
    ds.to_netcdf("models/psl_zg_pr10_tas_to_tas_era5_lag3_COMMITTOR.nc")
    model.save("models/psl_zg_pr10_tas_to_tas_era5_lag3_COMMITTOR.keras")
    np.save('models/psl_zg_pr10_tas_to_tas_era5_lag3_COMMITTOR.npy',history.history)
