...
if __name__ == "__main__":
	...
	dataset_train = CustomDataset(psl_file_train, zg_file_train, pr10_file_train, tas_file_train, batch_size=64,lag=5)
	dataset_val = CustomDataset(psl_file_val, zg_file_val, pr10_file_val, tas_file_val, batch_size=64,lag=5,std_ref_psl=dataset_train.psl_std, std_ref_zg=dataset_train.zg_std,std_ref_pr10=dataset_train.pr10_std,std_red_tas=dataset_train.tas_std)
...
callbacks = [
    ...
    keras.callbacks.ModelCheckpoint("models/psl_zg_pr10_tas_to_tas_ipsl_lag5.keras", save_best_only=True),
]
...
ds.to_netcdf("models/psl_zg_pr10_tas_to_tas_ipsl_lag5.nc")
model.save("models/psl_zg_pr10_tas_to_tas_ipsl_lag5.keras")
np.save('models/psl_zg_pr10_tas_to_tas_ipsl_lag5.npy',history.history)
