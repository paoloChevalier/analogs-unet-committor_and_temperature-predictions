...
dataset_val = CustomDataset(psl_file_val, zg_file_val, pr10_file_val, tas_file_val, batch_size=64,lag=9,std_ref_psl=dataset_train.psl_std, std_ref_zg=dataset_train.zg_std,std_ref_pr10=dataset_train.pr10_std)
...
callbacks = [
    ...
    keras.callbacks.ModelCheckpoint("models/psl_zg_pr10_to_tas_ipsl_lag9.keras", save_best_only=True),
]
...
ds.to_netcdf("models/psl_zg_pr10_to_tas_ipsl_lag9.nc")
model.save("models/psl_zg_pr10_to_tas_ipsl_lag9.keras")
np.save('models/psl_zg_pr10_to_tas_ipsl_lag9.npy',history.history)
