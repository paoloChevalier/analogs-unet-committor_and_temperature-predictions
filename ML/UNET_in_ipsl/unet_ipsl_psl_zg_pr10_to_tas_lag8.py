...
callbacks = [
    ...
    keras.callbacks.ModelCheckpoint("models/psl_zg_pr10_to_tas_ipsl_lag8.keras", save_best_only=True),
]
...
ds.to_netcdf("models/psl_zg_pr10_to_tas_ipsl_lag8.nc")
model.save("models/psl_zg_pr10_to_tas_ipsl_lag8.keras")
np.save('models/psl_zg_pr10_to_tas_ipsl_lag8.npy',history.history)
