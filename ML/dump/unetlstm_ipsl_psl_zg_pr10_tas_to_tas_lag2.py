...
if __name__ == "__main__":
    ...
    callbacks = [
        ...
        keras.callbacks.ModelCheckpoint("models/psl_zg_pr10_tas_to_tas_ipsl_lag2_lstm.keras", save_best_only=True),
    ]
    ...
    ds.to_netcdf("models/psl_zg_pr10_tas_to_tas_ipsl_lag2_lstm.nc")
    model.save("models/psl_zg_pr10_tas_to_tas_ipsl_lag2_lstm.keras")
    np.save('models/psl_zg_pr10_tas_to_tas_ipsl_lag2_lstm.npy',history.history)
